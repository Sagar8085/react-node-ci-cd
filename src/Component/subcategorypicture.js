...
export default function SubcategoryPicture(props){
...
var result = await postDataAndImage("subcategorypic/addnewsubcategorypic",formData,config);
if(result)
{
  swal({
    title: "Console Submitted Successfully",
    icon: "success",
    dangerMode: true,
  })
}

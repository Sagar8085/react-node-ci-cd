...
if(isBlank(gameName))
{error=true
  msg+="<font color='#eb4d4b'><b>Game Name should not be blank..</b></font><br>"
}
...
if(error)
{
  swalhtml(renderHTML(msg))
    ...
    var result = await postDataAndImage("game/gameadd",formData,config);
    if(result)
    {
      swal({
...
<div className={classes.root}>
    <div className={classes.subdiv}>
        ...
        {FillSubcategory()}
            ...
            <Grid item xs={12}>
                <TextField label="Game Name" variant="outlined" fullWidth onChange={(event)=>setGameName(event.target.value)} />
            </Grid>
            <Grid item xs={6}>
